...
:::{#def-signed-rank-sum}
## Signed-Rank Sum
The **signed-rank sum**, denoted $T$, is a test statistic used for nonparametric testing of a population location. Given data $(X_1, \dots, X_n)$, the data are first transformed into a set of ranks, $(R_1, \dots, R_n)$, determined by ranking the absolute values, $(|X_1|, \dots, |X_n|)$. Then, $$T = \sum_{i=1}^n \text{sgn}(X_i)R_i.$$
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.B.SignedRankNoTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, cloze_schoice_display = "buttons")
```
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.C.SignedRankTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, cloze_schoice_display = "buttons")
```
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.D.MannWhitneyNoTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, cloze_schoice_display = "buttons")
```
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.E.MannWhitneyTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, cloze_schoice_display = "buttons")
```
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.F.PairedSignedRankNoTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, cloze_schoice_display = "buttons")
```
:::
...
#| warning: false
#| cache: true
exams2forms(file="17.G.PairedSignedRankTies.Rmd", 
            edir = "../PracticeQuestions/Chapter17", 
            n = 100, 
