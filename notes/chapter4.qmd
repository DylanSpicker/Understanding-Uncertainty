...
e. Taking $A$ to be "competitive" we have $P(A) = 0.75$. Taking $B$ to be "heavy" we have $P(B) = 0.45$. Thus, if they were independent, we would have $P(A,B) = P(A)P(B) = (0.75)(0.45) = 0.3375$. This would require $33.75$ games to be heavy, competitive games, and so we must conclude that they are **not** independent. 
