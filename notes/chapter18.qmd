...
#| warning: false
#| cache: true
cache_check <- 123456780
exams2forms("18.A.GoodnessOfFit.Rmd", 
            edir = "../PracticeQuestions/Chapter18", 
            n = 50)
```
:::
...
exams2forms("18.B.Homogeneity.Rmd", 
            edir = "../PracticeQuestions/Chapter18", 
            n = 50)
```
:::
...
#| cache: true
cache_check <- 12345678
exams2forms("18.C.Independence.Rmd", 
            edir = "../PracticeQuestions/Chapter18", 
            n = 50)
```
:::
