...
## General Named Distributions and the Discrete Uniform
...
d. Sadie, in a round of guess-their-birthday, starts to count the number of guesses it takes until someone's birthday is guessed correctly.
...
a. A baseball player wants is interested in the number of home runs they hit in a game, where the probability of hitting a home run is the same for each at-bat.
