...
a. $$E_1 \cup E_2 =  \{(\text{H}, \text{H}, \text{H}), (\text{T}, \text{H}, \text{H}), (\text{H}, \text{T}, \text{H})\} = E_2.$$ As a result, the union of $E_1$ and $E_2$ is simply $E_2$.^[Note that whenever we have two events, $A$ and $B$, with $A\subseteqB$, then $A\cup B = B$.]
b. $$E_1 \cap E_2 = \{(\text{H}, \text{H}, \text{H})\} = E_1.$$ As a result, the intersection of $E_1$ and $E_2$ is simply $E_1$.^[Note that whenever we have two events, $A$ and $B$, with $A\subseteqB$ then $A \cap B = A$.]
