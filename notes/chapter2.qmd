...
:::{#def-disjoint-events}
## Disjoint Events
To events, $E_1$ and $E_2$ are said to be disjoint whenever their intersection is the null event. That is, if $E_1 \cap E_2 = \emptyset$ then $E_1$ and $E_2$ are disjoint events.
:::
