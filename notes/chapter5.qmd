...
#| warning: false
#| cache: true
exams2forms("5.A.DiscreteVersusContinuous.Rmd", 
            edir = "../PracticeQuestions/Chapter5", 
            n = 100)
```
:::
...
exams2forms("5.C.ProbabilitiesFromPmf.Rmd", 
            edir = "../PracticeQuestions/Chapter5", 
            n = 100)
```
:::
...
exams2forms("5.E.ConditionalProbs.Rmd", 
            edir = "../PracticeQuestions/Chapter5", 
            n = 100)
```
:::
...
#| warning: false
#| cache: true
cache_check <- 12345678999

exams2forms("5.F.IIDJointPMF.Rmd", 
            edir = "../PracticeQuestions/Chapter5", 
            n = 100)
```
:::
