...
Using these data^[Horst AM, Hill AP, Gorman KB (2020). palmerpenguins: Palmer Archipelago (Antarctica) penguin data. R package Version 0.1.0. https://allisonhorst.github.io/palmerpenguins/. doi:11.5281/zenodo.3960218.] answer the following.
...
a. To get the distribution for species, we add up along each row to get the total observed data into a frequency table. To get the relative frequency, the frequency is divided by $344$.
```{r}
#| echo: false
...
:::{#exr-11.0A}
In a survey conducted among students, they were asked about their favourite colors. The options were red, blue, green, yellow, and orange. Below are the responses from 10 students. Use these data to construct a frequency distribution.
...
:::{#exr-11.0C}
In a class of 30 students, each student was asked to choose their favourite genre of music from rock, pop, hip-hop, jazz, and classical. Below are the responses for 10 of them.
...
exams2forms("11.A.FrequencyDistribution.Rmd", 
            edir = "../PracticeQuestions/Chapter11", 
            n = 50)
```
:::
...
exams2forms("11.B.FrequencyDistributionContinuous.Rmd", 
            edir = "../PracticeQuestions/Chapter11", 
            n = 50)
```
:::
...
exams2forms("11.C.ShapeOfDistribution.Rmd", 
            edir = "../PracticeQuestions/Chapter11", 
            n = 50)
```
:::
...
exams2forms("11.D.SummaryStatistics.Rmd", 
            edir = "../PracticeQuestions/Chapter11", 
            n = 50)
```
:::
...
exams2forms("11.E.MatchHistogramAndBP.Rmd", 
            edir = "../PracticeQuestions/Chapter11", 
            n = 25)
```
:::
