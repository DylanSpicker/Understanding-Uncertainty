...
a. Express the probability that a student is between 57 and 73 inches tall in terms of $\Phi(z)$.
...
#| warning: false
#| cache: true
cache_check <- 1234567890000
exams2forms("9.A.GivenCDF.Rmd", 
            edir = "../PracticeQuestions/Chapter9", 
            n = 50)
```
:::
...
exams2forms("9.B.NormalProbabilities.Rmd", 
            edir = "../PracticeQuestions/Chapter9", 
            n = 50)
```
:::
...
exams2forms("9.C.NormalApproximationToTheBinomial.Rmd", 
            edir = "../PracticeQuestions/Chapter9", 
            n = 50)
```
:::
