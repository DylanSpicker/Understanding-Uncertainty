...
b. What is the mode of $Y$?
c. What is the variance of $Y$?
d. What is the range of $Y$?
e. What is the standard deviation of $Y$?
:::
...
d. What is the standard deviation of $Z$?
:::
...
a. What is the expected value of $W$?
b. What is the mode of $W$?
c. What is the variance of $W$?
d. What is $\zeta(0.3)$? 
e. What is $\zeta(0.8)$?
e. What is the standard deviation of $W$?
:::

:::{#exr-6.15}
Consider a book containing 200 pages. You randomly select a page number. Let $X$ represent the sum of the digits in the page number selected.
...
exams2forms("6.A.BasicExpectedValueAndVariance.Rmd", 
            edir = "../PracticeQuestions/Chapter6", 
            n = 100)
```
:::
...
#| cache: true
cache_check <- 123456
exams2forms("6.B.LinearTransformation.Rmd", 
            edir = "../PracticeQuestions/Chapter6", 
            n = 100)
```
:::
...
#| cache: true
cache_check <- 123456
exams2forms("6.C.SummaryStatistics.Rmd", 
            edir = "../PracticeQuestions/Chapter6", 
            n = 100)
```
:::
