...
A parameter is a numeric quantity of interest which is defined for a population. A parameter captures the behaviour of the population. Typically, the value of parameters will be unknown and unknowable.
:::
...
a. The percentage of households with pets in a country.
:::
...
exams2forms("10.A.ParametersAndStatistics.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
#| cache: true
cache_check <- 12345678900
exams2forms("10.B.PopulationDefinition.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.C.SampleDefinition.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.D.ParametersVersusStatistics.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.E.VariableTypes.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
#| warning: false
#| cache: true
cache_check <- 12345678

exams2forms("10.F.TypesOfStatistics.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.G.SamplingMethods.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.H.ProportionalAllocation.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50)
```
:::
...
exams2forms("10.I.ExperimentalComponents.Rmd", 
            edir = "../PracticeQuestions/Chapter10", 
            n = 50,
            usecase = FALSE,
            usespace = FALSE)
