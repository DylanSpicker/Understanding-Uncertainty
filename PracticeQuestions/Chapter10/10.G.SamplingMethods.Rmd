...
clustered <- c(
    "A university wants to study the satisfaction level of its students. They randomly select several classrooms and survey all the students systent in those classrooms.",
...
multistage <- c(
    ...
    "To understand the travel habits of tourists in a country, the tourism board first selects several popular tourist strattinations, then randomly selects hotels within each strattination, and finally surveys a random sample of guests staying at those hotels.",
