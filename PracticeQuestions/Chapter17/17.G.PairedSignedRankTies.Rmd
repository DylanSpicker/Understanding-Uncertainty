...
```{r dataoutput2, results = "asis", echo=FALSE} 
    cat(paste0("| |", paste0(1:n, collapse=" | "), "\n"))
    cat(paste0("|:-:|", paste0(rep(":-:|", n), collapse=""), "\n"))
    cat(paste0("|$X$|", paste0(X, collapse=" | "), "\n"))
    cat(paste0("|$Y$|", paste0(Y, collapse=" | "), "\n"))
```
