...
From their sample, they observe $\overline{X} = `r format(Xbar, scientific=FALSE)`$ (with sample standard deviation $`r sigmaX`$) and $\overline{Y} = `r format(Ybar, scientific=FALSE)`$ (with sample standard deviation $`r sigmaY`$).
