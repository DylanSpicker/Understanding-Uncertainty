...
if(sc == 1) {
    qscenario <- "A group of researchers are studying the impact of a newly designed medication on blood pressure. They measure individual's systolic blood pressure before ($X$) and after ($Y$) taking the medicaiton."
    ...
    qscenario <- "A group of researchers are studying the impact of a particular diet on blood pressure. They measure individual's systolic blood pressure before ($X$) and after ($X$) starting the diet."
