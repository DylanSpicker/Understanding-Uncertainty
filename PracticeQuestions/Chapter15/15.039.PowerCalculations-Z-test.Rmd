...
ans2 <- ceiling((popSd * (qnorm(1-power) + qnorm(1-alpha/2))/abs(Delta))^2)
...
b. What is the approximate sample size required in order achieve a power of $`r power`$? ##ANSWER2##
